  ...
  return (
    <button
      ...
      className={`flex h-8 w-14 shrink-0 cursor-pointer items-center rounded-full p-1 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 ${
        checked ? "bg-teal-500" : "bg-slate-200 dark:bg-slate-600"
      }`}
    >
      <span
      ...
      <div className="divide-y divide-slate-100 dark:divide-slate-800">
        <div className="flex flex-col gap-4 py-6 first:pt-0 sm:flex-row sm:items-center sm:justify-between sm:gap-8">
          <div className="min-w-0">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-50">SMS ogohlantirishlari</h2>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Yuqori xavf aniqlanganda ota-onaga</p>
          </div>
        ...
        <div className="flex flex-col gap-4 py-6 sm:flex-row sm:items-center sm:justify-between sm:gap-8">
          <div className="min-w-0 flex-1">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-50">Xavf chegarasi (Yuqori)</h2>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Hozirgi chegara: {riskCap} ball</p>
          </div>
        ...
        <div className="flex flex-col gap-4 py-6 last:pb-0 sm:flex-row sm:items-center sm:justify-between sm:gap-8">
          <div className="min-w-0">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-50">Maktab nomi</h2>
          </div>
          <input
            type="text"
            value={schoolName}
            onChange={(e) => setSchoolName(e.target.value)}
            className="w-full max-w-xs rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 shadow-sm outline-none ring-teal-500/20 focus:border-teal-500 focus:ring-2 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-50 sm:max-w-sm"
