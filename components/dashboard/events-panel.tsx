  ...
  return (
    <section className="flex h-full min-h-[220px] flex-col rounded-xl border border-slate-200/80 bg-white dark:border-slate-800/80 dark:bg-slate-900/50 dark:shadow-black/20 p-5 shadow-sm">
      <div className="mb-4 flex items-center gap-2">
        ...
        <h2 className="text-base font-semibold text-slate-900 dark:text-slate-50">Hodisalar</h2>
      </div>
        ...
        {events.map((e, i) => (
          <li key={i} className="relative flex gap-3 py-2.5 pl-0">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm leading-snug text-slate-800 dark:text-slate-200">{e.text}</p>
