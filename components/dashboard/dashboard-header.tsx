        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap">
          ...
          <label className="relative flex min-w-[200px] flex-1 sm:max-w-xs">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white py-2.5 pl-10 pr-3 text-sm text-slate-900 shadow-sm outline-none ring-teal-500/30 placeholder:text-slate-400 focus:border-teal-500 focus:ring-2"
            />
          </label>
          <button
            type="button"
