  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      <article className="rounded-xl border border-slate-200/80 bg-white p-5 shadow-sm">
        ...
        <p className="mt-4 text-3xl font-bold tracking-tight text-slate-900">1</p>
        <p className="mt-1 text-sm text-slate-500">Jami o'quvchilar</p>
      </article>
      ...
      <article className="rounded-xl border border-slate-200/80 bg-white p-5 shadow-sm">
        ...
        <p className="mt-4 text-3xl font-bold tracking-tight text-slate-900">0</p>
        <p className="mt-1 text-sm text-slate-500">Yuqori xavf</p>
      </article>
      ...
      <article className="rounded-xl border border-slate-200/80 bg-white p-5 shadow-sm">
        ...
        <p className="mt-4 text-3xl font-bold tracking-tight text-slate-900">0</p>
        <p className="mt-1 text-sm text-slate-500">O'rtacha xavf</p>
      </article>
      ...
      <article className="rounded-xl border border-slate-200/80 bg-white p-5 shadow-sm">
        ...
        <p className="mt-4 text-3xl font-bold tracking-tight text-slate-900">1</p>
        <p className="mt-1 text-sm text-slate-500">Xavfsiz</p>
      </article>
    </div>
  );
}
